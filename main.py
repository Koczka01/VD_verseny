...
while penzkeret > 0 and elegedettseg >= e_elegedettseg and hossza > 0:
    while parancs != 'kovetkezo':
        ...
        if parancs == "parancsok":
            ...
            alma = epuletek.Epulet(int(input('Adja meg az épület azonosítóját: ')), input('Adja meg az épület nevét: '), input('Adja meg az épület típusát: '), int(jelen.ev), int(input('Adja meg az épület hasznos területét: ')))
